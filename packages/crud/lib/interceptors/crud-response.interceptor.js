...
let CrudResponseInterceptor = class CrudResponseInterceptor extends crud_base_interceptor_1.CrudBaseInterceptor {
    ...
    transform(dto, data) {
        if (!(0, crud_util_1.isObject)(data) || (0, crud_util_1.isFalse)(dto)) {
            return data;
        }
        if (!(0, crud_util_1.isFunction)(dto)) {
...
exports.CrudResponseInterceptor = CrudResponseInterceptor = __decorate([
