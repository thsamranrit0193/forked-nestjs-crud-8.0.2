...
exports.swagger = (0, util_1.safeRequire)('@nestjs/swagger', () => require('@nestjs/swagger'));
exports.swaggerConst = (0, util_1.safeRequire)('@nestjs/swagger/dist/constants', () => require('@nestjs/swagger/dist/constants'));
exports.swaggerPkgJson = (0, util_1.safeRequire)('@nestjs/swagger/package.json', () => require('@nestjs/swagger/package.json'));
class Swagger {
    ...
    static setExtraModels(swaggerModels) {
        if (exports.swaggerConst) {
            ...
            const models = [
                ...meta,
                ...(0, crud_util_1.objKeys)(swaggerModels)
    ...
    static createPathParamsMeta(options) {
        return exports.swaggerConst
            ? (0, crud_util_1.objKeys)(options).map((param) => ({
                name: param,
                required: true,
                in: 'path',
    ...
    static getQueryParamsNames() {
        ...
        const name = (n) => {
            ...
            return (0, crud_util_1.isString)(selected) ? selected : selected[0];
        };
        return {
