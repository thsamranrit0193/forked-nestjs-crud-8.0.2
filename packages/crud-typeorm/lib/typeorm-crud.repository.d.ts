import { CreateManyDto, CrudRequest, CrudRequestOptions, CrudRepository, CustomOperators, GetManyDefaultResponse, JoinOption, JoinOptions, QueryOptions } from '@lab3dvlp/crud';
import { ComparisonOperator, ParsedRequestParams, QueryFilter, QueryJoin, QuerySort, SCondition, SConditionKey } from '@lab3dvlp/crud-request';
import { ClassType } from '@lab3dvlp/crud-util';
import { Brackets, DataSourceOptions, DeepPartial, EntityMetadata, ObjectLiteral, Repository, SelectQueryBuilder, WhereExpressionBuilder } from 'typeorm';
...
export declare class TypeOrmCrudRepository<T> extends CrudRepository<T, DeepPartial<T>> {
    ...
    replaceOne(req: CrudRequest, dto: DeepPartial<T>, replaceEntity?: boolean): Promise<T>;
