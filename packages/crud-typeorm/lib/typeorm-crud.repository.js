...
exports.TypeOrmCrudRepository = void 0;
const crud_1 = require("@lab3dvlp/crud");
const crud_util_1 = require("@lab3dvlp/crud-util");
const o0_1 = require("@zmotivat0r/o0");
const class_transformer_1 = require("class-transformer");
const typeorm_1 = require("typeorm");
class TypeOrmCrudRepository extends crud_1.CrudRepository {
    constructor(repo) {
        super();
        this.repo = repo;
    ...
    async updateOne(req, dto) {
        ...
        const entityInstance = (0, class_transformer_1.plainToInstance)(this.entityType, toSave);
    ...
    async replaceOne(req, dto, replaceEntity = false) {
        if (!replaceEntity)
    ...
    async deleteOne(req) {
        ...
        const toReturn = returnDeleted
            ? (0, class_transformer_1.plainToInstance)(this.entityType, { ...found })
            : undefined;
    ...
    prepareEntityBeforeSave(dto, parsed) {
        ...
        return dto instanceof this.entityType
            ...
            : (0, class_transformer_1.plainToInstance)(this.entityType, { ...dto, ...parsed.authPersist });
    }
    ...
    setSearchCondition(builder, search, customOperators, condition = '$and') {
        if ((0, crud_util_1.isObject)(search)) {
            ...
            if (keys.length) {
                if ((0, crud_util_1.isArrayFull)(search.$and)) {
...
exports.TypeOrmCrudRepository = TypeOrmCrudRepository;
//# sourceMappingURL=typeorm-crud.repository.js.map